    ...
    return (
        <div className='hero-container'>
            ...
            <div className='profile-container'>
                ...
                <a className='download-resume cta-button' href='https://drive.google.com/file/d/1zkl7a0Zh35Dj2VtFLHeX3t92vmLwbCuV/view?usp=drive_link' download target='_blank' rel='noreferrer'>Resume
